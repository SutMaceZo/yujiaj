...
import com.chaotong.yujia.main.adapter.HyKsAdapter;
...
public class HyWcksActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            if (code!=null&&message!=null){
                if(code.equals("1")){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(HyWcksActivity.this);
                    ...
                    builder.setTitle(getResources().getString(R.string.app_name) + "")
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    editor.commit();
                                    Intent intent = new Intent(HyWcksActivity.this, loginActivity.class);
                                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    startActivity(intent);
                                }
                            }).show();
                } else {
                    Toast.makeText(HyWcksActivity.this,wcks.getMsg(),Toast.LENGTH_SHORT).show();
                }
            }else {
                Toast.makeText(HyWcksActivity.this,getResources().getString(R.string.error),Toast.LENGTH_SHORT).show();
            }
                    ...
                    if (code != null) {
                        if (code.equals("1") || code.equals("0")) {
                            ...
                            if (list != null && list.size() > 0) {
                                adapter = new HyKsAdapter(HyWcksActivity.this, list);
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     void initView() {
        ...
        if(!("").equals(reqid)) {
            ...
            new ThreadUtils(HyWcksActivity.this, url, content, handler).start();
        }else {
            Toast.makeText(HyWcksActivity.this,"请重新登录",Toast.LENGTH_SHORT).show();
        }
...
more=0;
                    ...
                    if(!("").equals(reqid)) {
                        ...
                        Toast.makeText(HyWcksActivity.this,"请先登录",Toast.LENGTH_SHORT).show();
                    }
            ...
            new Handler()
            {
                ...
                public void handleMessage(Message msg)
                {
                    ...
                    if(!("").equals(reqid)) {
                        ...
                        new ThreadUtils(HyWcksActivity.this, url, content, xhandler).start();
                    }
                    // 千万别忘了告诉控件加载完毕了哦！
