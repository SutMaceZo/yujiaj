...
public class ViewPagerIndicator extends LinearLayout{
    ...
    private static final int COLOR_TEXT_HIGHLIGHT = 0xFFB38ED3;
    ...
    public void scroll(int position, float offset) {
        // 不断改变偏移量，invalidate
        //mTabVisibleCount 可见tab数量
        mTranslationX = (int) (getWidth() / mTabVisibleCount * (position + offset));
        // tabWidth 每个tab的宽度
    ...
    private View generateTextView(String title) {
        ...
        lp.width = getScreenWidth() / mTabVisibleCount - 8;
        tv.setText(title);
